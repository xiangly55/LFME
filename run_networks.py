...
class model ():
    ...
    def batch_loss(self, labels):
        ...
        self.writer.add_scalar('loss/PerformanceLoss', self.loss, current_global_step)
    ...
    def train(self):
        ...
        for epoch in range(1, end_epoch + 1):
            ...
            # current_lr = self.model_optimizer_scheduler.get_lr()[0]
            # self.writer.add_scalar('lr/learning_rate', current_lr, self.epoch)
